...
- V5.9.0 is a Preview-only candidate after normal PR and CI. Browser Harness is unavailable in this environment, so no browser visual acceptance is claimed. Staging requires separate explicit approval. Production is forbidden.
