...
test('看板按待取车口径标注：待门店拣货 与 在途车辆', () => {
  assert.match(board, /pick: \{ en: 'SHIPHUB PICKING', cn: '待门店拣货', action: '确认拣货', actionType: 'pick' \}/u)
  ...
  assert.match(board, /receive: \{ en: 'SHIPHUB RECEIVE', cn: '待收货', action: '确认收货', actionType: 'receive' \}/u)
