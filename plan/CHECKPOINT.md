...
## 当前状态加注（2026-08-11 22:0x +08:00 · 自助密码修改已提交待 PR）

**恢复入口**：`docs/progress/2026-08-11-self-service-password-change.md`。

- 工作分支：`feat/self-service-password-change-20260811`，基线 `e608e17`（V5.9.2），功能提交 `32e1406`。本次尚未推送、创建 PR、部署 Preview 或 Production，也未变更正式版本号。
