...
export default function ConfirmClosingDialog({ open, onClose, onConfirm }) {
  ...
  return (
    <AppDialog open={open} onClose={onClose} title="确认完成闭店" eyebrow="FINAL CHECK · 最终确认" description="今天的销售数据已经填写，这是当前唯一的闭店要求。" signalModule="closing" registration="CLOSING / COMMIT">
