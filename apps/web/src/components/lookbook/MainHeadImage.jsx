...
export default function MainHeadImage() {
  return (
    <figure className="main-head-image" aria-labelledby="main-head-title">
      <picture>
      ...
      <figcaption className="head-photo-caption">
        <span data-editorial-description>WORKSHOP OPERATIONS</span>
        <VisualLineText as="strong" id="main-head-title">维修与闭店工作台</VisualLineText>
        <em data-editorial-description>Workshop Ledger</em>
      </figcaption>
    </figure>
  )
}
