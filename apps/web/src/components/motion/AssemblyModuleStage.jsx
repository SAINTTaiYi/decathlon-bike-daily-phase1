...
const visualByScene = {
  pulse: { image: '/images/ops/reference-home/mechanic-workbench-1600.webp', layout: 'admission', overline: 'WORKSHOP OPERATIONS', copy: '真实台账、当日信号与闭店动作，共享同一张持续工作的画面。' },
...
export default function AssemblyModuleStage({ scene }) {
  ...
  return <div className="assembly-module-stage" data-assembly-stage={visual.layout} data-stage-scene={scene.id} aria-hidden="true">
    <figure className="assembly-stage-image">
      <img src={visual.image} alt="" width="1600" height="1067" loading={scene.id === 'pulse' ? 'eager' : 'lazy'} decoding="async" />
    </figure>
