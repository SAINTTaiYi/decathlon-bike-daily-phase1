      ...
      <section className="registration-panel" aria-labelledby="registration-title">
        ...
        {!loading && step === 0 ? (
          <form className="data-form" onSubmit={sendOtp} noValidate>
            ...
            <label className="field-row"><span>Profile</span><input required autoComplete="username" maxLength="24" value={form.username} onChange={(event) => { clearFeedback(); set('username', event.target.value) }} placeholder="例如：小王" /></label>
