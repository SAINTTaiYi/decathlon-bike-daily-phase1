...
export default function ResaleScene(props) {
  ...
  return (
    <section className="look-section" data-signal-module={scene.signalModule} data-depth-section={scene.id} id={scene.id} data-look={scene.id} aria-labelledby={`${scene.id}-title`}>
