...
export default function PickupScene(props) {
  ...
  return (
    <section className="look-section pickup-look" data-signal-module={scene.signalModule} data-depth-section={scene.id} id={scene.id} data-look={scene.id} aria-labelledby={`${scene.id}-title`}>
